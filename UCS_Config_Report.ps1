...
.SYNOPSIS
    UCS Configuration Report v4.0 forked from UCS Health Check v2.6
...
.NOTES
    ...
    You must have an active internet connection to view the report as it streams some javascript and css files to
    build report.

    Use the UseCached, RunReport, and Email switch options to automate script execution (especially if scheduling
    script as a task).
